...
📄 **[Project poster (PDF)](docs/Project%20Poster.PDF)** — full visual summary
...
├── docs/
│   └── Project Poster.PDF            # A1 conference-style poster
...
```bash
git clone https://github.com/emmadismail/shape-detection-cv-vs-dl.git
...
Python · OpenCV · PyTorch · ResNet18 (transfer learning) · NumPy · Raspberry Pi camera · SSH-based parallel capture tooling
